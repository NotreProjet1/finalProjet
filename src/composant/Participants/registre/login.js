...
const Login = ({ setLoggedIn }) => {
  ...
  return (
    <div>
      ...
      <MDBCard className="cardd mx-auto  shadow-5-strong" style={{ backgroundPosition: "center", marginTop: "-300px", width: "40%", background: "hsla(0, 0%, 100%, 0.3)", backdropFilter: "blur(30px)" ,border:"1px solid black ", marginBottom:"10px" }}
      >
        <MDBCardBody>
