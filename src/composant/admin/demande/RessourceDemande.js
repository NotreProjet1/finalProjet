        ...
        <MDBTableBody>
          {currentItems.map((Ressource) => (
            <tr key={Ressource.id_r}>
              ...
              <td>
                <MDBBtn color='success' rounded size='sm' onClick={() => handleAccept(Ressource.id_r)}>
                  Accepter
                </MDBBtn>
                <MDBBtn color='danger' rounded size='sm' onClick={() => handleReject(Ressource.id_r)}>
                  Refuser
                </MDBBtn>
              </td>
            </tr>
...
export default RessourcesDemande;
