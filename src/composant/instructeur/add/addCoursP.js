...
const AddCoursP = () => {
    ...
    useEffect(() => {
        // Mettez à jour la liste des cours chaque fois que le composant est rendu ou que le nombre de cours créés change
    }, [coursList]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Réinitialiser les champs du formulaire pour permettre la création du cours suivant
            setcoursData({
                titre: '',
                description: '',
                plantFile: null,
    ...
    const getButtonLabel = () => {
        const numCours = coursList.length + 1; // Ajoutez 1 pour le cours actuellement en cours de création
