...
const Navbar = ({ reloadnavbar, isLoggedIn, setLoggedIn, role }) => {
    ...
    return (
        <nav className='nav'>
            <div className='s1'>
                <img src='/images/logadmin.png' alt='logo' className='logo' />
                <div className='s2'>
                    <Link to='/'>
                        <a>Home</a>
                    </Link>
                    <Dropdown className=''>
                        ...
                        <Dropdown.Menu className="custom-dropdown-menu"> 
                            <Dropdown.Item href="/QuizList" className="custom-dropdown-item"> QuizList</Dropdown.Item>
                            <Dropdown.Item href="/AddQuiz" className="custom-dropdown-item"> AddQuiz</Dropdown.Item>
                            <Dropdown.Item href="/loginAdmin" className="custom-dropdown-item"> loginAdmin</Dropdown.Item>
                            <Dropdown.Item href="/FormationsListPayent" className="custom-dropdown-item"> FormationsListPayent</Dropdown.Item>
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Menu className="custom-dropdown-menu">
                            <Dropdown.Item href="/CoursGList" className="custom-dropdown-item"> CoursGList</Dropdown.Item>
                            <Dropdown.Item href="/FormationsList" className="custom-dropdown-item">FormationsList </Dropdown.Item>
                            <Dropdown.Item href="/RessourceList" className="custom-dropdown-item"> RessourceList</Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
